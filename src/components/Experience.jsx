...
function Experience() {
    ...
    const exp = [
        ...
        },
        {
            ...
            abilities: [css, typescript, javascript, node, postgres, reactimg, docker],
            image: "",
            category: "fullstack",
            links: [
                {
        ...
        },
        {
            ...
            description: "Full Stack and mobile development for a product focused on authentication, API consumption, notifications and user experience. Implemented Android features with Jetpack Compose, Hilt and Retrofit, with Firebase and OneSignal integrations, alongside React and REST APIs.",
            descriptionES: "Desarrollo full stack y mobile de un producto enfocado en autenticación, consumo de APIs, notificaciones y experiencia de usuario. Implementé funcionalidades Android con Jetpack Compose, Hilt y Retrofit, integraciones con Firebase y OneSignal, además de trabajo con React y APIs REST.",
        ...
        },
        {
            ...
            description: "Built the official website, an independent ticket sales system, content administration and frontend/backend functionality.",
            descriptionES: "Desarrollé el sitio oficial, un sistema independiente de venta de entradas, administración de contenidos y funcionalidades de frontend y backend.",
        ...
        },
        {
            ...
            description: "Backend development for a delivery application, including the database, orders, users, restaurants, meals and shopping cart.",
            descriptionES: "Desarrollo backend para una aplicación de delivery, incluyendo base de datos, pedidos, usuarios, restaurantes, comidas y carrito.",
        ...
        },
        {
            ...
            description: "Sports complex app with searches, filters, tournaments, registrations, standings and top scorers. Built with React, Redux, Tailwind, Node.js, Express, PostgreSQL and Sequelize.",
            descriptionES: "Aplicación para complejo deportivo con búsquedas, filtros, torneos, inscripciones, posiciones y goleadores. Desarrollada con React, Redux, Tailwind, Node.js, Express, PostgreSQL y Sequelize.",
            abilities: [css, express, javascript, node, postgres, reactimg, redux, sequelize],
            image: "",
            category: "front",
            links: [
        ...
        },
        {
            ...
            date: "Henry Bootcamp 2022",
            dateES: "Henry Bootcamp 2022",
            description: "Full stack app with searches, filters, sorting, API consumption and its own persistence layer.",
            descriptionES: "Aplicación full stack con búsquedas, filtros, ordenamiento, consumo de API y persistencia propia.",
            abilities: [express, javascript, node, postgres, reactimg, redux, sequelize],
            image: "",
            category: "front"
        },
    ]
    ...
    return (
        <div ref={experienceRef} className="initanimation">
            ...
            <div className={`selector ${isVisible ? "selectorVisible" : "selectorHidden"}`}>
                {
                    [
                        {
